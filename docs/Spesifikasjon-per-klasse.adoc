== Krav til RDF-representasjon av klassene i ModellDCAT-AP-NO [[Spesifikasjon-per-klasse]]
...
[[img-KlasseOversikt]]
.Klassene i ModellDCAT-AP-NO.
[link=images/ModellDCAT-AP-NO-klasser.png]
image::images/ModellDCAT-AP-NO-klasser.png[alt="UML-diagram med klassene som er i ModellDCAT-AP-NO og noen av relasjoner mellom dem. Innholdet i diagrammet er forklart i teksten."]
...
| Kravnivå / _Requirement level_ | Denne brukes bare i spesifikasjon av en egenskap, til å spesifisere om egenskapen er obligatorisk, anbefalt eller valgfri. Se også kap. <<Om-kravene>>.
