...
|Egenskap: øvre multiplisitet| xsd:maxOccurs | Range endret fra `xsd:nonNegativeInteger` til `xsd:nonNegativeInteger eller xsd:string` | For å kunne ha "*" eller "n" som øvre multiplisitet.
