...
|Kodeelement: neste kodeelement|xkos:next|Endret multiplisitet, fra o..n til 0..1.|Skrivefeil
|Kodeelement: forrige kodeelement|xkos:previous|Endret multiplisitet, fra o..n til 0..1.|Skrivefeil
|===
