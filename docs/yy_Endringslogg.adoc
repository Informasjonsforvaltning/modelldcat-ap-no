= Vedlegg - Endringslogg [[Endringslogg]]

== Endringer fra v.1.3.0 til v.1.3.1 [[Endringer_fra_v_1.3.1]]

Kapitler og underkapitler er nå nummerert slik at kravene i spesifikasjonen har hvert sitt nøyaktige referanse0nummer. 
