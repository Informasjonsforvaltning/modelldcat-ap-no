...
For at det følgende skal virke på din maskin, må du ha programvare installert:  
 ...
 Dersom du bruker Atom kan du gjøre som følger:  
  ...
  - I Clone from legger du inn følgende url `https://github.com/Informasjonsforvaltning/modelldcat-ap-no.git`

Alternativt i kommando-linje:
```
% git clone https://github.com/Informasjonsforvaltning/modelldcat-ap-no.git
% cd modelldcat-ap-no
...
Gå til https://github.com/Informasjonsforvaltning/modelldcat-ap-no/pulls og opprett `New pull request`
...
bash-5.0# asciidoctor-pdf -D docs -o modelldcat-ap-no.pdf docs/main.adoc
```
